...
const UserInfo = ({ avatar, title }) => {
  return (
    <div className="header__user">
      <img className="header__user-image" src={avatar} alt="user avatar" />
...
const HeaderPageChat = ({ chat }) => {
  ...
  const userInfo = (chat && chat.avatar && chat.title) ? <UserInfo avatar={chat.avatar} title={chat.title} /> : null;
